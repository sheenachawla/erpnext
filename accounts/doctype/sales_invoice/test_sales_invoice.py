...
class TestSalesInvoice(unittest.TestCase):
	...
	def test_inclusive_rate_validations(self):
		doclist = [] + [d.copy() for d in sales_invoice_doclist]
		doclist[1]["print_rate"] = 62.5
		doclist[2]["print_rate"] = 191
	...
	def test_sales_invoice_with_inclusive_tax(self):
		doclist = [
			...
			{
				"doctype": "Sales Invoice Item", "warehouse": "Default Warehouse",
				"item_code": "Home Desktop 100", "qty": 10, "print_rate": 62.503,
				"parentfield": "sales_invoice_items",
				"uom": "Nos", "item_tax_rate": json.dumps({"Excise Duty - %s" % abbr: 10})
			},
			{
				"doctype": "Sales Invoice Item", "warehouse": "Default Warehouse",
				"item_code": "Home Desktop 200", "qty": 5, "print_rate": 190.6608,
				"parentfield": "sales_invoice_items",
				"uom": "Nos"
			},
			# taxes
			{
				"doctype": "Sales Taxes and Charges", "charge_type": "On Net Total",
				"account_head": "Excise Duty - %s" % abbr, "rate": 12,
				"parentfield": "taxes_and_charges", "included_in_print_rate": 1
			},
			{
			...
			{
				"doctype": "Sales Taxes and Charges", "charge_type": "Actual",
				"account_head": "Shipping Charges - %s" % abbr, "tax_amount_print": 100, 
				"parentfield": "taxes_and_charges",
				"cost_center": "Default Cost Center - %s" % abbr
			},
			{
		...
		expected_values = [
			...
			["Discount - %s" % abbr, -180.33, 1623, -180.33, 1623],
		]		
		for i, tax in enumerate(dl.get({"parentfield": "taxes_and_charges"})):
		...
		self.assertEqual(dl[0].grand_total_print, 1623)
	...
	def test_usd_sales_invoice_with_inclusive_tax(self):
		...
		doclist = [
			# parent
			{
				...
				"company": company,
				"fiscal_year": webnotes.conn.get_default("fiscal_year"), 
				"currency": "USD", "exchange_rate": 50.0,
				"grand_total_print": 0
			},
			# items
			{
				"doctype": "Sales Invoice Item", "warehouse": "Default Warehouse",
				"item_code": "Home Desktop 100", "qty": 10, "print_rate": 50,
				"discount": 10, "parentfield": "sales_invoice_items",
				"uom": "Nos", "item_tax_rate": json.dumps({"Excise Duty - %s" % abbr: 10})
			},
			{
				"doctype": "Sales Invoice Item", "warehouse": "Default Warehouse",
				"item_code": "Home Desktop 200", "qty": 5, "print_rate": 150,
				"discount": 20, "parentfield": "sales_invoice_items",
				"uom": "Nos"
			},
			# taxes
			{
		...
		expected_values = [
			...
			["Discount - %s" % abbr, -7245.01, 65205.16, -144.9, 1304.11],
		]		
		for i, tax in enumerate(dl.get({"parentfield": "taxes_and_charges"})):
			# print tax.account_head, tax.tax_amount, tax.total, tax.tax_amount_print, \
			# 	tax.total_print
		...
		self.assertEqual(dl[0].grand_total_print, 1304.11)
