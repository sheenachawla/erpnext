...
def create_default_master_records():
	records = [
		...
		{'voucher_type': 'parent:doctype', 'doctype': 'GL Mapper Detail', 'cost_center': 'cost_center', 'voucher_no': 'parent:name',  'table_field': 'purchase_tax_details', 'transaction_date': 'parent:voucher_date', 'debit': "value:d.get('category') != 'For Valuation' and d.get('add_deduct_tax') == 'Add' and d.get('tax_amount') or 0", 'parent': 'Purchase Invoice', 'company': 'parent:company', 'aging_date': 'parent:aging_date', 'fiscal_year': 'parent:fiscal_year', 'remarks': 'parent:remarks', 'account': 'account_head', 'idx': '2', 'against': 'parent:credit_to', 'credit': "value:d.get('category') != 'For Valuation' and d.get('add_deduct_tax') == 'Deduct' and d.get('tax_amount') or 0", 'parenttype': 'GL Mapper', 'is_opening': 'parent:is_opening', 'posting_date': 'parent:posting_date', 'parentfield': 'fields'}, 
		...
		{'account': 'account_head ', 'against': 'parent:credit_to ', 'aging_date': 'parent:aging_date ', 'company': 'parent:company ', 'cost_center': 'cost_center ', 'credit': "value:d.get('category') != 'For Valuation' and d.get('add_deduct_tax') == 'Deduct' and d.get('tax_amount') or 0", 'debit': "value:d.get('category') != 'For Valuation' and d.get('add_deduct_tax') == 'Add' and d.get('tax_amount') or 0",  'doctype': 'GL Mapper Detail', 'fiscal_year': 'parent:fiscal_year ', 'is_opening': 'parent:is_opening ', 'posting_date': 'parent:posting_date ', 'remarks': 'parent:remarks ', 'table_field': 'purchase_tax_details ', 'transaction_date': 'parent:voucher_date ', 'voucher_no': 'parent:name ', 'voucher_type': 'parent:doctype ', 'doctype': 'GL Mapper Detail', 'parent': 'Purchase Invoice with write off ', 'parentfield': 'fields ', 'parenttype': 'GL Mapper'},
