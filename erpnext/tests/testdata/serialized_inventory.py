...
mr1 = [
	...
	{'doctype': 'Stock Entry Detail', 'parenttype': 'Stock Entry', 'parentfield' : 'mtn_details', 'parent' : 'MR002', 'name': 'SED002', 'item_code' : 'test_item_serialized', 't_warehouse' : 'test_wh1', 'qty' : 5, 'transfer_qty' : 5, 'incoming_rate': 400, 'stock_uom': 'Nos', 'conversion_factor': 1, 'serial_no': 'srno11, srno12, srno13, srno14, srno15'}
]
...
mtn = [
	...
	{'doctype': 'Stock Entry Detail', 'parenttype': 'Stock Entry', 'parentfield' : 'mtn_details', 'parent' : 'MTN001', 'name': 'SED003', 'item_code' : 'test_item_serialized', 's_warehouse' : 'test_wh1', 't_warehouse' : 'test_wh2', 'qty' : 5, 'transfer_qty' : 5, 'incoming_rate': 100, 'stock_uom': 'Nos', 'conversion_factor': 1, 'serial_no': 'srno1, srno2, srno3, srno4, srno5'}
]
...
mi = [
	...
	{'doctype': 'Stock Entry Detail', 'parenttype': 'Stock Entry', 'parentfield' : 'mtn_details', 'parent' : 'MI001', 'name': 'SED004', 'item_code' : 'test_item_serialized', 's_warehouse' : 'test_wh1', 'qty' : 4, 'transfer_qty' : 4, 'incoming_rate': 100, 'stock_uom': 'Nos', 'conversion_factor': 1, 'serial_no': 'srno1, srno2, srno3, srno4'}
]