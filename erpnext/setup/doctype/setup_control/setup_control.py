...
class DocType:
	...
	def add_roles(self, pr):
		roles_list = ['Accounts Manager', 'Accounts User', 'Blogger', 'HR Manager', 'HR User', \
			'Maintenance User', 'Maintenance Manager', 'Material Manager', 'Material User', \
			'Material Master Manager', 'Production Manager', 'Production User', 'Projects User', \
