...
cur_frm.cscript.select_form = function(doc, cdt, cdn){
  ...
  var call_back_action = function(mydoc){
    $c('runserverobj', args={'method':'field_label_list', 'docs':wn.model.compress (wn.model.get_doclist (mydoc.doctype,mydoc.name))},
    function(r, rt) {
  ...
  var call_back_rule = function(mydoc){
    $c('runserverobj', args={'method':'compare_field', 'docs':wn.model.compress (wn.model.get_doclist (mydoc.doctype,mydoc.name))},
    function(r, rt) {
      var doc = locals[mydoc.doctype][mydoc.name];
  ...
  $c('runserverobj', args={'method':'maindoc_field', 'docs':wn.model.compress (wn.model.get_doclist (doc.doctype,doc.name))},
    function(r, rt) {
     var doc = locals[mydoc.doctype][mydoc.name];
