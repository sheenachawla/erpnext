...
def create_doc(records):
	...
	webnotes.conn.begin()
	for data in records:
		if (data.get('name') and not webnotes.conn.exists(data['doctype'], data.get('name'))) or not webnotes.conn.exists(data):
...
def create_default_master_records():
	records = [
		...
		{'doctype': 'Item Group', 'item_group_name': 'Default', 'is_group': 'No', 'name': 'Default', \
			'parent_item_group': 'All Item Groups'},
		# deduction type
		{'doctype': 'Deduction Type', 'name': 'Income Tax', 'description': 'Income Tax', \
		'is_active': 'Yes', 'module': 'Payroll', 'deduction_name': 'Income Tax'},
		{'doctype': 'Deduction Type', 'name': 'Professional Tax', 'description': 'Professional Tax', \
			'is_active': 'Yes', 'module': 'Payroll', 'deduction_name': 'Professional Tax'},
		{'doctype': 'Deduction Type', 'name': 'Provident Fund', 'description': 'Provident fund', \
			'is_active': 'Yes', 'module': 'Payroll', 'deduction_name': 'Provident Fund'},
		# earning type
		{'doctype': 'Earning Type', 'name': 'Basic', 'description': 'Basic', 'is_active': 'Yes', \
			'earning_name': 'Basic', 'taxable': 'Yes', 'module': 'Payroll'},
		{'doctype': 'Earning Type', 'name': 'House Rent Allowance', 'description': 'House Rent Allowance', \
			'is_active': 'Yes', 'earning_name': 'House Rent Allowance', 'taxable': 'No', 'module': 'Payroll'},
		# expense claim type
		{'doctype': 'Expense Claim Type', 'name': 'Calls', 'module': 'Payroll', 'expense_type': 'Calls'},
		{'doctype': 'Expense Claim Type', 'name': 'Food', 'module': 'Payroll', 'expense_type': 'Food'},
		{'doctype': 'Expense Claim Type', 'name': 'Medical', 'module': 'Payroll', 'expense_type': 'Medical'},
		{'doctype': 'Expense Claim Type', 'name': 'Others', 'module': 'Payroll', 'expense_type': 'Others'},
		{'doctype': 'Expense Claim Type', 'name': 'Travel', 'module': 'Payroll', 'expense_type': 'Travel'},
		# leave type
		{'doctype': 'Leave Type', 'leave_type_name': 'Casual Leave', 'name': 'Casual Leave', \
			'is_encash': 1, 'is_active': 'Yes', 'is_carry_forward': 1, 'max_days_allowed': '3', 'module': 'Payroll'},
		{'doctype': 'Leave Type', 'leave_type_name': 'Compensatory Off', 'name': 'Compensatory Off', \
			'is_encash': 0, 'is_active': 'Yes', 'is_carry_forward': 0, 'module': 'Payroll'},
		...
		{'doctype': 'Leave Type', 'leave_type_name': 'Leave Without Pay', 'name': 'Leave Without Pay', \
			'is_encash': 0, 'is_active': 'Yes', 'is_carry_forward': 0, 'module': 'Payroll'},
		# territory
		{'doctype': 'Territory', 'item_group_name': 'All Territories', 'is_group': 'Yes', \
			'name': 'All Territories', 'parent_item_group': ''},
		{'doctype': 'Territory', 'item_group_name': 'Default', 'is_group': 'No', \
			'name': 'Default', 'parent_item_group': 'All Territories'},
			
		# customer group
		{'doctype': 'Customer Group', 'item_group_name': 'All Customer Groups', 'is_group': 'Yes', \
			'name': 'All Customer Groups', 'parent_item_group': ''},
		{'doctype': 'Customer Group', 'item_group_name': 'Default Customer Group', 'is_group': 'No', 'name': 'Default Customer Group', \
		...
		# warehouse 
		{'doctype': 'Warehouse', 'warehouse_name': 'Default Warehouse', 'name': 'Default Warehouse', \
			'warehouse_type': 'Default Warehouse Type'},
		...
		{'state_name': 'Chengdu ', 'country': 'China', 'doctype': 'State', 'name': 'Chengd'}, 
		...
		{'state_name': 'Hangzhou ', 'country': 'China', 'doctype': 'State', 'name': 'Hangzho'}, 
		...
		{'category': 'Professional Fees - 194J - for Companies', 'name': '000008839', 'parent': 'Rate chart (01-07-2010)', 'doctype': 'TDS Rate Detail', 'idx': 1, 'parenttype': 'TDS Rate Chart', 'rate_without_pan': 20.0, 'rate': 10.0, 'slab_from': 30000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Professional Fees - 194J - for Individuals', 'name': '000008840', 'parent': 'Rate chart (01-07-2010)', 'doctype': 'TDS Rate Detail', 'idx': 2, 'parenttype': 'TDS Rate Chart', 'rate_without_pan': 20.0, 'rate': 10.0, 'slab_from': 30000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Contractors - 194C - for Companies', 'name': '000008841', 'parent': 'Rate chart (01-07-2010)', 'doctype': 'TDS Rate Detail', 'idx': 3, 'parenttype': 'TDS Rate Chart', 'rate_without_pan': 20.0, 'rate': 2.0, 'slab_from': 30000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Contractors - 194C - for Individuals', 'name': '000008842', 'parent': 'Rate chart (01-07-2010)', 'doctype': 'TDS Rate Detail', 'idx': 4, 'parenttype': 'TDS Rate Chart', 'rate_without_pan': 20.0, 'rate': 1.0, 'slab_from': 30000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'T.D.S on Other Interest - for Individuals', 'name': '000008843', 'parent': 'Rate chart (01-07-2010)', 'doctype': 'TDS Rate Detail', 'idx': 5, 'parenttype': 'TDS Rate Chart', 'rate_without_pan': 20.0, 'rate': 10.0, 'slab_from': 5000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Pay to Advt Or Sub Contr - for Companies', 'name': '000008844', 'parent': 'Rate chart (01-07-2010)', 'doctype': 'TDS Rate Detail', 'idx': 6, 'parenttype': 'TDS Rate Chart', 'rate_without_pan': 20.0, 'rate': 2.0, 'slab_from': 30000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Pay to Advt Or Sub Contr - for Individuals', 'name': '000008845', 'parent': 'Rate chart (01-07-2010)', 'doctype': 'TDS Rate Detail', 'idx': 7, 'parenttype': 'TDS Rate Chart', 'rate_without_pan': 20.0, 'rate': 1.0, 'slab_from': 30000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Commission Brokerage - for Companies', 'name': '000008846', 'parent': 'Rate chart (01-07-2010)', 'doctype': 'TDS Rate Detail', 'idx': 8, 'parenttype': 'TDS Rate Chart', 'rate_without_pan': 20.0, 'rate': 10.0, 'slab_from': 5000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Commission Brokerage - for Individuals', 'name': '000008847', 'parent': 'Rate chart (01-07-2010)', 'doctype': 'TDS Rate Detail', 'idx': 9, 'parenttype': 'TDS Rate Chart', 'rate_without_pan': 20.0, 'rate': 10.0, 'slab_from': 5000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'T.D.S on Rent - for Companies', 'name': '000008848', 'parent': 'Rate chart (01-07-2010)', 'doctype': 'TDS Rate Detail', 'idx': 10, 'parenttype': 'TDS Rate Chart', 'rate_without_pan': 20.0, 'rate': 10.0, 'slab_from': 180000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'T.D.S on Rent - for Individuals', 'name': '000008849', 'parent': 'Rate chart (01-07-2010)', 'doctype': 'TDS Rate Detail', 'idx': 11, 'parenttype': 'TDS Rate Chart', 'rate_without_pan': 20.0, 'rate': 10.0, 'slab_from': 180000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'TDS on ECB Loan', 'name': '000008850', 'parent': 'Rate chart (01-07-2010)', 'doctype': 'TDS Rate Detail', 'idx': 12, 'parenttype': 'TDS Rate Chart', 'rate_without_pan': 20.0, 'rate': 10.0, 'slab_from': 5000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'TDS on Rent (Machinery)', 'name': '000008851', 'parent': 'Rate chart (01-07-2010)', 'doctype': 'TDS Rate Detail', 'idx': 13, 'parenttype': 'TDS Rate Chart', 'rate_without_pan': 20.0, 'rate': 2.0, 'slab_from': 180000.0, 'parentfield': 'rate_chart_detail'},
		{'applicable_from': '2008-01-01', 'name': 'TDS Rate Chart for 2009-10', 'module': 'Accounts', 'doctype': 'TDS Rate Chart', 'applicable_to': '2009-09-30', }, 
		{'category': 'Professional Fees - 194J - for Companies', 'slab_to': 10000000.0, 'name': '000001291', 'parent': 'TDS Rate Chart for 2009-10', 'ec': 0.20000000000000001, 'doctype': 'TDS Rate Detail', 'shec': 0.10000000000000001, 'idx': 1, 'parenttype': 'TDS Rate Chart', 'rate': 10.0, 'slab_from': 20000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Professional Fees - 194J - for Companies', 'slab_to': 100000000.0, 'name': '000001292', 'parent': 'TDS Rate Chart for 2009-10', 'ec': 0.20000000000000001, 'doctype': 'TDS Rate Detail', 'shec': 0.10000000000000001, 'idx': 2, 'parenttype': 'TDS Rate Chart', 'surcharge': 1.0, 'rate': 10.0, 'slab_from': 10000000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Professional Fees - 194J - for Individuals', 'slab_to': 10000000.0, 'name': '000001293', 'parent': 'TDS Rate Chart for 2009-10', 'ec': 0.20000000000000001, 'doctype': 'TDS Rate Detail', 'shec': 0.10000000000000001, 'idx': 3, 'parenttype': 'TDS Rate Chart', 'rate': 10.0, 'slab_from': 20000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Professional Fees - 194J - for Individuals', 'slab_to': 100000000.0, 'name': '000001294', 'parent': 'TDS Rate Chart for 2009-10', 'ec': 0.20000000000000001, 'doctype': 'TDS Rate Detail', 'shec': 0.10000000000000001, 'idx': 4, 'parenttype': 'TDS Rate Chart', 'surcharge': 1.0, 'rate': 10.0, 'slab_from': 10000000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Contractors - 194C - for Companies', 'slab_to': 10000000.0, 'name': '000001295', 'parent': 'TDS Rate Chart for 2009-10', 'ec': 0.040000000000000001, 'doctype': 'TDS Rate Detail', 'shec': 0.02, 'idx': 5, 'parenttype': 'TDS Rate Chart', 'rate': 2.0, 'slab_from': 20000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Contractors - 194C - for Companies', 'slab_to': 100000000.0, 'name': '000001296', 'parent': 'TDS Rate Chart for 2009-10', 'ec': 0.040000000000000001, 'doctype': 'TDS Rate Detail', 'shec': 0.02, 'idx': 6, 'parenttype': 'TDS Rate Chart', 'surcharge': 0.20000000000000001, 'rate': 2.0, 'slab_from': 10000000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Contractors - 194C - for Individuals', 'slab_to': 10000000.0, 'name': '000001297', 'parent': 'TDS Rate Chart for 2009-10', 'ec': 0.02, 'doctype': 'TDS Rate Detail', 'shec': 0.01, 'idx': 7, 'parenttype': 'TDS Rate Chart', 'rate': 1.0, 'slab_from': 20000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Contractors - 194C - for Individuals', 'slab_to': 100000000.0, 'name': '000001298', 'parent': 'TDS Rate Chart for 2009-10', 'ec': 0.02, 'doctype': 'TDS Rate Detail', 'shec': 0.01, 'idx': 8, 'parenttype': 'TDS Rate Chart', 'surcharge': 0.10000000000000001, 'rate': 1.0, 'slab_from': 10000000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'T.D.S on Other Interest - for Individuals', 'slab_to': 10000000.0, 'name': '000001299', 'parent': 'TDS Rate Chart for 2009-10', 'ec': 0.20000000000000001, 'doctype': 'TDS Rate Detail', 'shec': 0.10000000000000001, 'idx': 9, 'parenttype': 'TDS Rate Chart', 'rate': 10.0, 'slab_from': 5000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'T.D.S on Other Interest - for Individuals', 'slab_to': 100000000.0, 'name': '000001300', 'parent': 'TDS Rate Chart for 2009-10', 'ec': 0.20000000000000001, 'doctype': 'TDS Rate Detail', 'shec': 0.10000000000000001, 'idx': 10, 'parenttype': 'TDS Rate Chart', 'surcharge': 1.0, 'rate': 10.0, 'slab_from': 10000000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Pay to Advt Or Sub Contr - for Companies', 'slab_to': 10000000.0, 'name': '000001301', 'parent': 'TDS Rate Chart for 2009-10', 'ec': 0.040000000000000001, 'doctype': 'TDS Rate Detail', 'shec': 0.02, 'idx': 11, 'parenttype': 'TDS Rate Chart', 'surcharge': 0.0, 'rate': 2.0, 'slab_from': 20000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Pay to Advt Or Sub Contr - for Companies', 'slab_to': 100000000.0, 'name': '000001302', 'parent': 'TDS Rate Chart for 2009-10', 'ec': 0.040000000000000001, 'doctype': 'TDS Rate Detail', 'shec': 0.02, 'idx': 12, 'parenttype': 'TDS Rate Chart', 'surcharge': 0.20000000000000001, 'rate': 2.0, 'slab_from': 10000000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Pay to Advt Or Sub Contr - for Individuals', 'slab_to': 10000000.0, 'name': '000001303', 'parent': 'TDS Rate Chart for 2009-10', 'ec': 0.02, 'doctype': 'TDS Rate Detail', 'shec': 0.01, 'idx': 13, 'parenttype': 'TDS Rate Chart', 'surcharge': 0.0, 'rate': 1.0, 'slab_from': 20000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Pay to Advt Or Sub Contr - for Individuals', 'slab_to': 100000000.0, 'name': '000001304', 'parent': 'TDS Rate Chart for 2009-10', 'ec': 0.02, 'doctype': 'TDS Rate Detail', 'shec': 0.01, 'idx': 14, 'parenttype': 'TDS Rate Chart', 'surcharge': 0.10000000000000001, 'rate': 1.0, 'slab_from': 10000000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Commission Brokerage - for Companies', 'slab_to': 10000000.0, 'name': '000001305', 'parent': 'TDS Rate Chart for 2009-10', 'ec': 0.20000000000000001, 'doctype': 'TDS Rate Detail', 'shec': 0.10000000000000001, 'idx': 15, 'parenttype': 'TDS Rate Chart', 'surcharge': 0.0, 'rate': 10.0, 'slab_from': 2500.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Commission Brokerage - for Companies', 'slab_to': 100000000.0, 'name': '000001306', 'parent': 'TDS Rate Chart for 2009-10', 'ec': 0.20000000000000001, 'doctype': 'TDS Rate Detail', 'shec': 0.10000000000000001, 'idx': 16, 'parenttype': 'TDS Rate Chart', 'surcharge': 1.0, 'rate': 10.0, 'slab_from': 10000000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Commission Brokerage - for Individuals', 'slab_to': 10000000.0, 'name': '000001307', 'parent': 'TDS Rate Chart for 2009-10', 'ec': 0.20000000000000001, 'doctype': 'TDS Rate Detail', 'shec': 0.10000000000000001, 'idx': 17, 'parenttype': 'TDS Rate Chart', 'rate': 10.0, 'slab_from': 2500.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Commission Brokerage - for Individuals', 'slab_to': 100000000.0, 'name': '000001308', 'parent': 'TDS Rate Chart for 2009-10', 'ec': 0.20000000000000001, 'doctype': 'TDS Rate Detail', 'shec': 0.10000000000000001, 'idx': 18, 'parenttype': 'TDS Rate Chart', 'surcharge': 1.0, 'rate': 10.0, 'slab_from': 10000000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'T.D.S on Rent - for Companies', 'slab_to': 10000000.0, 'name': '000001309', 'parent': 'TDS Rate Chart for 2009-10', 'ec': 0.20000000000000001, 'doctype': 'TDS Rate Detail', 'shec': 0.10000000000000001, 'idx': 19, 'parenttype': 'TDS Rate Chart', 'surcharge': 0.0, 'rate': 10.0, 'slab_from': 120000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'T.D.S on Rent - for Companies', 'slab_to': 100000000.0, 'name': '000001310', 'parent': 'TDS Rate Chart for 2009-10', 'ec': 0.20000000000000001, 'doctype': 'TDS Rate Detail', 'shec': 0.10000000000000001, 'idx': 20, 'parenttype': 'TDS Rate Chart', 'surcharge': 1.0, 'rate': 10.0, 'slab_from': 10000000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'T.D.S on Rent - for Individuals', 'slab_to': 10000000.0, 'name': '000001311', 'parent': 'TDS Rate Chart for 2009-10', 'ec': 0.20000000000000001, 'doctype': 'TDS Rate Detail', 'shec': 0.10000000000000001, 'idx': 21, 'parenttype': 'TDS Rate Chart', 'surcharge': 0.0, 'rate': 10.0, 'slab_from': 120000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'T.D.S on Rent - for Individuals', 'slab_to': 100000000.0, 'name': '000002623', 'parent': 'TDS Rate Chart for 2009-10', 'ec': 0.20000000000000001, 'doctype': 'TDS Rate Detail', 'shec': 0.10000000000000001, 'idx': 22, 'parenttype': 'TDS Rate Chart', 'surcharge': 1.0, 'rate': 10.0, 'slab_from': 10000000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'TDS on ECB Loan', 'slab_to': 10000000.0, 'name': '000001390', 'parent': 'TDS Rate Chart for 2009-10', 'ec': 0.20000000000000001, 'doctype': 'TDS Rate Detail', 'shec': 0.10000000000000001, 'idx': 23, 'parenttype': 'TDS Rate Chart', 'surcharge': 0.0, 'rate': 10.0, 'slab_from': 5000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'TDS on ECB Loan', 'slab_to': 100000000.0, 'name': '000002624', 'parent': 'TDS Rate Chart for 2009-10', 'ec': 0.20000000000000001, 'doctype': 'TDS Rate Detail', 'shec': 0.10000000000000001, 'idx': 24, 'parenttype': 'TDS Rate Chart', 'surcharge': 1.0, 'rate': 10.0, 'slab_from': 10000000.0, 'parentfield': 'rate_chart_detail'},
		{'applicable_from': '2009-10-01', 'name': 'TDS Rate Chart October 2009 Onwards', 'module': 'Accounts', 'doctype': 'TDS Rate Chart', 'applicable_to': '2010-03-31', }, 
		{'category': 'Professional Fees - 194J - for Companies', 'slab_to': 10000000.0, 'name': '000002625', 'parent': 'TDS Rate Chart October 2009 Onwards', 'doctype': 'TDS Rate Detail', 'shec': 0.0, 'idx': 1, 'parenttype': 'TDS Rate Chart', 'surcharge': 0.0, 'rate': 10.0, 'slab_from': 20000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Professional Fees - 194J - for Individuals', 'slab_to': 10000000.0, 'name': '000002627', 'parent': 'TDS Rate Chart October 2009 Onwards', 'doctype': 'TDS Rate Detail', 'shec': 0.0, 'idx': 2, 'parenttype': 'TDS Rate Chart', 'surcharge': 0.0, 'rate': 10.0, 'slab_from': 20000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Contractors - 194C - for Companies', 'slab_to': 10000000.0, 'name': '000002629', 'parent': 'TDS Rate Chart October 2009 Onwards', 'doctype': 'TDS Rate Detail', 'shec': 0.0, 'idx': 3, 'parenttype': 'TDS Rate Chart', 'surcharge': 0.0, 'rate': 2.0, 'slab_from': 20000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Contractors - 194C - for Individuals', 'slab_to': 10000000.0, 'name': '000002631', 'parent': 'TDS Rate Chart October 2009 Onwards', 'doctype': 'TDS Rate Detail', 'shec': 0.0, 'idx': 4, 'parenttype': 'TDS Rate Chart', 'surcharge': 0.0, 'rate': 1.0, 'slab_from': 20000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'T.D.S on Other Interest - for Individuals', 'slab_to': 10000000.0, 'name': '000002633', 'parent': 'TDS Rate Chart October 2009 Onwards', 'doctype': 'TDS Rate Detail', 'shec': 0.0, 'idx': 5, 'parenttype': 'TDS Rate Chart', 'surcharge': 0.0, 'rate': 10.0, 'slab_from': 5000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Pay to Advt Or Sub Contr - for Companies', 'slab_to': 10000000.0, 'name': '000002635', 'parent': 'TDS Rate Chart October 2009 Onwards', 'doctype': 'TDS Rate Detail', 'shec': 0.0, 'idx': 6, 'parenttype': 'TDS Rate Chart', 'surcharge': 0.0, 'rate': 2.0, 'slab_from': 20000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Pay to Advt Or Sub Contr - for Individuals', 'slab_to': 10000000.0, 'name': '000002637', 'parent': 'TDS Rate Chart October 2009 Onwards', 'doctype': 'TDS Rate Detail', 'shec': 0.0, 'idx': 7, 'parenttype': 'TDS Rate Chart', 'surcharge': 0.0, 'rate': 1.0, 'slab_from': 20000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Commission Brokerage - for Companies', 'slab_to': 10000000.0, 'name': '000002639', 'parent': 'TDS Rate Chart October 2009 Onwards', 'doctype': 'TDS Rate Detail', 'shec': 0.0, 'idx': 8, 'parenttype': 'TDS Rate Chart', 'surcharge': 0.0, 'rate': 10.0, 'slab_from': 2500.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'Commission Brokerage - for Individuals', 'slab_to': 10000000.0, 'name': '000002641', 'parent': 'TDS Rate Chart October 2009 Onwards', 'doctype': 'TDS Rate Detail', 'shec': 0.0, 'idx': 9, 'parenttype': 'TDS Rate Chart', 'surcharge': 0.0, 'rate': 10.0, 'slab_from': 2500.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'T.D.S on Rent - for Companies', 'slab_to': 10000000.0, 'name': '000002643', 'parent': 'TDS Rate Chart October 2009 Onwards', 'doctype': 'TDS Rate Detail', 'shec': 0.0, 'idx': 10, 'parenttype': 'TDS Rate Chart', 'surcharge': 0.0, 'rate': 10.0, 'slab_from': 120000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'T.D.S on Rent - for Individuals', 'slab_to': 10000000.0, 'name': '000002645', 'parent': 'TDS Rate Chart October 2009 Onwards', 'doctype': 'TDS Rate Detail', 'shec': 0.0, 'idx': 11, 'parenttype': 'TDS Rate Chart', 'surcharge': 0.0, 'rate': 10.0, 'slab_from': 120000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'TDS on ECB Loan', 'slab_to': 10000000.0, 'name': '000002646', 'parent': 'TDS Rate Chart October 2009 Onwards', 'doctype': 'TDS Rate Detail', 'shec': 0.0, 'idx': 12, 'parenttype': 'TDS Rate Chart', 'surcharge': 0.0, 'rate': 10.0, 'slab_from': 5000.0, 'parentfield': 'rate_chart_detail'}, 
		{'category': 'TDS on Rent (Machinery)', 'name': '000007335', 'parent': 'TDS Rate Chart October 2009 Onwards', 'doctype': 'TDS Rate Detail', 'idx': 13, 'parenttype': 'TDS Rate Chart', 'rate': 2.0, 'slab_from': 120000.0, 'parentfield': 'rate_chart_detail'},
		 
		# GL Mapper - JV
		{'doc_type': 'Journal Voucher', 'name': 'Journal Voucher', 'module': 'Accounts', 'doctype': 'GL Mapper'}, 
		{'voucher_type': 'parent:doctype', 'doctype': 'GL Mapper Detail', 'cost_center': 'cost_center', 'voucher_no': 'parent:name', 'against_voucher': "value:d.against_voucher or d.against_invoice or d.against_jv or ''", 'table_field': 'entries', 'transaction_date': 'parent:voucher_date', 'debit': 'debit', 'parent': 'Journal Voucher', 'company': 'parent:company', 'aging_date': 'parent:aging_date', 'fiscal_year': 'parent:fiscal_year', 'is_advance': 'is_advance', 'remarks': 'parent:remark', 'account': 'account', 'name': 'GLMDetail00001', 'idx': 1, 'against_voucher_type': "value:(d.against_voucher and 'Purchase Invoice') or (d.against_invoice and 'Sales Invoice') or (d.against_jv and 'Journal Voucher') or ''", 'against': 'against_account', 'credit': 'credit', 'parenttype': 'GL Mapper', 'is_opening': 'parent:is_opening', 'posting_date': 'parent:posting_date', 'parentfield': 'fields'}, 
		{'creation': '2009-06-11 11:09:11', 'voucher_type': 'doctype', 'doctype': 'GL Mapper Detail', 'cost_center': '', 'voucher_no': 'name', 'against_voucher': '', 'table_field': '', 'transaction_date': 'voucher_date', 'debit': 'value:0', 'parent': 'Journal Voucher', 'company': 'company', 'aging_date': 'aging_date', 'fiscal_year': 'fiscal_year', 'is_advance': '', 'remarks': 'remark', 'account': 'tax_code', 'name': 'GLMDetail00009', 'idx': 2, 'against_voucher_type': None, 'against': 'supplier_account', 'credit': 'ded_amount', 'parenttype': 'GL Mapper', 'is_opening': 'is_opening', 'posting_date': 'posting_date', 'parentfield': 'fields'},
		# GL Mapper - POS
		{'doc_type': 'POS', 'name': 'POS', 'doctype': 'GL Mapper'}, 
		{'voucher_type': 'parent:doctype', 'doctype': 'GL Mapper Detail', 'cost_center': 'cost_center', 'voucher_no': 'parent:name', 'against_voucher': None, 'table_field': 'entries', 'transaction_date': 'parent:voucher_date', 'debit': 'value:0', 'parent': 'POS', 'company': 'parent:company', 'aging_date': 'parent:aging_date', 'fiscal_year': 'parent:fiscal_year', 'is_advance': None, 'remarks': 'parent:remarks', 'account': 'income_account', 'name': 'GLMDetail00010', 'idx': 1, 'against_voucher_type': None, 'against': 'parent:debit_to', 'credit': 'amount', 'parenttype': 'GL Mapper', 'is_opening': 'parent:is_opening', 'posting_date': 'parent:posting_date', 'parentfield': 'fields'}, 
		{'voucher_type': 'parent:doctype', 'doctype': 'GL Mapper Detail', 'cost_center': 'cost_center_other_charges', 'voucher_no': 'parent:name', 'against_voucher': None, 'table_field': 'other_charges', 'transaction_date': 'parent:voucher_date', 'debit': 'value:0', 'parent': 'POS', 'company': 'parent:company', 'aging_date': 'parent:aging_date', 'fiscal_year': 'parent:fiscal_year', 'is_advance': None, 'remarks': 'parent:remarks', 'account': 'account_head', 'name': 'GLMDetail00011', 'idx': 2, 'against_voucher_type': None, 'against': 'parent:debit_to', 'credit': 'tax_amount', 'parenttype': 'GL Mapper', 'is_opening': 'parent:is_opening', 'posting_date': 'parent:posting_date', 'parentfield': 'fields'}, 
		{'voucher_type': 'doctype', 'doctype': 'GL Mapper Detail', 'cost_center': None, 'voucher_no': 'name', 'against_voucher': 'name', 'table_field': None, 'transaction_date': 'voucher_date', 'debit': 'grand_total', 'parent': 'POS', 'company': 'company', 'aging_date': 'aging_date', 'fiscal_year': 'fiscal_year', 'is_advance': None, 'remarks': 'remarks', 'account': 'debit_to', 'name': 'GLMDetail00012', 'idx': 3, 'against_voucher_type': 'doctype', 'against': 'against_income_account', 'credit': 'value:0', 'parenttype': 'GL Mapper', 'is_opening': 'is_opening', 'posting_date': 'posting_date', 'parentfield': 'fields'}, 
		{'voucher_type': 'doctype', 'doctype': 'GL Mapper Detail', 'cost_center': '', 'voucher_no': 'name', 'against_voucher': 'name', 'table_field': None, 'transaction_date': 'voucher_date', 'debit': 'value:0', 'parent': 'POS', 'company': 'company', 'aging_date': 'aging_date', 'fiscal_year': 'fiscal_year', 'is_advance': None, 'remarks': 'remarks', 'account': 'debit_to', 'name': 'GLMDetail00013', 'idx': 4, 'against_voucher_type': 'doctype', 'against': 'cash_bank_account', 'credit': 'paid_amount', 'parenttype': 'GL Mapper', 'is_opening': 'is_opening', 'posting_date': 'posting_date', 'parentfield': 'fields'}, 
		{'voucher_type': 'doctype', 'doctype': 'GL Mapper Detail', 'cost_center': '', 'voucher_no': 'name', 'against_voucher': '', 'table_field': None, 'transaction_date': 'voucher_date', 'debit': 'paid_amount', 'parent': 'POS', 'company': 'company', 'aging_date': 'aging_date', 'fiscal_year': 'fiscal_year', 'is_advance': None, 'remarks': 'remarks', 'account': 'cash_bank_account', 'name': 'GLMDetail00014', 'idx': 5, 'against_voucher_type': '', 'against': 'debit_to', 'credit': 'value:0', 'parenttype': 'GL Mapper', 'is_opening': 'is_opening', 'posting_date': 'posting_date', 'parentfield': 'fields'},
		# GL Mapper - POS with write off
		{'doc_type': 'POS with write off', 'doctype': 'GL Mapper', 'name': 'POS with write off'},
		{'account': 'income_account', 'against': 'parent:debit_to', 'against_voucher': None, 'against_voucher_type': None, 'aging_date': 'parent:aging_date', 'company': 'parent:company', 'cost_center': 'cost_center', 'credit': 'amount', 'debit': 'value:0', 'docstatus': 0, 'doctype': 'GL Mapper Detail', 'fiscal_year': 'parent:fiscal_year', 'idx': 1, 'is_advance': None, 'is_opening': 'parent:is_opening', 'name': '000002752', 'parent': 'POS with write off', 'parentfield': 'fields', 'parenttype': 'GL Mapper', 'posting_date': 'parent:posting_date', 'remarks': 'parent:remarks', 'table_field': 'entries', 'transaction_date': 'parent:voucher_date', 'voucher_no': 'parent:name', 'voucher_type': 'parent:doctype'},
		{'account': 'account_head', 'against': 'parent:debit_to', 'against_voucher': None, 'against_voucher_type': None, 'aging_date': 'parent:aging_date', 'company': 'parent:company', 'cost_center': 'cost_center_other_charges', 'credit': 'tax_amount', 'debit': 'value:0', 'docstatus': 0, 'doctype': 'GL Mapper Detail', 'fiscal_year': 'parent:fiscal_year', 'idx': 2, 'is_advance': None, 'is_opening': 'parent:is_opening', 'name': '000002753', 'parent': 'POS with write off', 'parentfield': 'fields', 'parenttype': 'GL Mapper', 'posting_date': 'parent:posting_date', 'remarks': 'parent:remarks', 'table_field': 'other_charges', 'transaction_date': 'parent:voucher_date', 'voucher_no': 'parent:name', 'voucher_type': 'parent:doctype'},
		{'account': 'debit_to', 'against': 'against_income_account', 'against_voucher': 'name', 'against_voucher_type': 'doctype', 'aging_date': 'aging_date', 'company': 'company', 'cost_center': None, 'credit': 'value:0', 'debit': 'grand_total', 'docstatus': 0, 'doctype': 'GL Mapper Detail', 'fiscal_year': 'fiscal_year', 'idx': 3, 'is_advance': None, 'is_opening': 'is_opening', 'name': '000002754', 'parent': 'POS with write off', 'parentfield': 'fields', 'parenttype': 'GL Mapper', 'posting_date': 'posting_date', 'remarks': 'remarks', 'table_field': None, 'transaction_date': 'voucher_date', 'voucher_no': 'name', 'voucher_type': 'doctype'},
		{'account': 'debit_to', 'against': 'cash_bank_account', 'against_voucher': 'name', 'against_voucher_type': 'doctype', 'aging_date': 'aging_date', 'company': 'company', 'cost_center': None, 'credit': 'paid_amount', 'debit': 'value:0', 'docstatus': 0,'doctype': 'GL Mapper Detail', 'fiscal_year': 'fiscal_year', 'idx': 4, 'is_advance': None, 'is_opening': 'is_opening', 'name': '000002755', 'parent': 'POS with write off', 'parentfield': 'fields', 'parenttype': 'GL Mapper', 'posting_date': 'posting_date', 'remarks': 'remarks', 'table_field': None, 'transaction_date': 'voucher_date', 'voucher_no': 'name', 'voucher_type': 'doctype'},
		{'account': 'debit_to', 'against': 'write_off_account', 'against_voucher': 'name', 'against_voucher_type': 'doctype', 'aging_date': 'aging_date', 'company': 'company', 'cost_center': None, 'credit': 'write_off_amount', 'debit': 'value:0', 'docstatus': 0, 'doctype': 'GL Mapper Detail', 'fiscal_year': 'fiscal_year', 'idx': 5, 'is_advance': None, 'is_opening': 'is_opening', 'name': '000002758', 'parent': 'POS with write off', 'parentfield': 'fields', 'parenttype': 'GL Mapper', 'posting_date': 'posting_date', 'remarks': 'remarks', 'table_field': None, 'transaction_date': 'voucher_date', 'voucher_no': 'name', 'voucher_type': 'doctype'},
		{'account': 'cash_bank_account', 'against': 'debit_to', 'against_voucher': None, 'against_voucher_type': None, 'aging_date': 'aging_date', 'company': 'company', 'cost_center': None, 'credit': 'value:0', 'debit': 'paid_amount', 'docstatus': 0, 'doctype': 'GL Mapper Detail', 'fiscal_year': 'fiscal_year', 'idx': 6, 'is_advance': None, 'is_opening': 'is_opening', 'name': '000002756', 'parent': 'POS with write off', 'parentfield': 'fields', 'parenttype': 'GL Mapper', 'posting_date': 'posting_date', 'remarks': 'remarks', 'table_field': None, 'transaction_date': 'voucher_date', 'voucher_no': 'name', 'voucher_type': 'doctype'},
		{'account': 'write_off_account', 'against': 'debit_to', 'against_voucher': None,'against_voucher_type': None,'aging_date': 'aging_date', 'company': 'company', 'cost_center': 'write_off_cost_center', 'credit': 'value:0', 'debit': 'write_off_amount', 'docstatus': 0,'doctype': 'GL Mapper Detail', 'fiscal_year': 'fiscal_year', 'idx': 7,'is_advance': None, 'is_opening': 'is_opening', 'name': '000002757', 'parent': 'POS with write off', 'parentfield': 'fields', 'parenttype': 'GL Mapper', 'posting_date': 'posting_date', 'remarks': 'remarks', 'table_field': None, 'transaction_date': 'voucher_date', 'voucher_no': 'name', 'voucher_type': 'doctype'},
		# GL Mapper - Purchase Invoice
		{'doc_type': 'Purchase Invoice', 'name': 'Purchase Invoice', 'module': 'Accounts', 'doctype': 'GL Mapper'}, 
		{'voucher_type': 'parent:doctype', 'doctype': 'GL Mapper Detail', 'cost_center': 'cost_center', 'voucher_no': 'parent:name', 'against_voucher': None, 'table_field': 'entries', 'transaction_date': 'parent:voucher_date', 'debit': 'amount', 'parent': 'Purchase Invoice', 'company': 'parent:company', 'aging_date': 'parent:aging_date', 'fiscal_year': 'parent:fiscal_year', 'is_advance': None, 'remarks': 'parent:remarks', 'account': 'expense_head', 'name': 'GLMDetail00002', 'idx': 1, 'against_voucher_type': None, 'against': 'parent:credit_to', 'credit': 'value:0', 'parenttype': 'GL Mapper', 'is_opening': 'parent:is_opening', 'posting_date': 'parent:posting_date', 'parentfield': 'fields'}, 
		{'voucher_type': 'parent:doctype', 'doctype': 'GL Mapper Detail', 'cost_center': 'cost_center', 'voucher_no': 'parent:name', 'against_voucher': None, 'table_field': 'purchase_tax_details', 'transaction_date': 'parent:voucher_date', 'debit': "value:d.fields.get('category') != 'For Valuation' and d.fields.get('add_deduct_tax') == 'Add' and d.fields.get('tax_amount') or 0", 'parent': 'Purchase Invoice', 'company': 'parent:company', 'aging_date': 'parent:aging_date', 'fiscal_year': 'parent:fiscal_year', 'is_advance': None, 'remarks': 'parent:remarks', 'account': 'account_head', 'name': 'GLMDetail00003', 'idx': 2, 'against_voucher_type': None, 'against': 'parent:credit_to', 'credit': "value:d.fields.get('category') != 'For Valuation' and d.fields.get('add_deduct_tax') == 'Deduct' and d.fields.get('tax_amount') or 0", 'parenttype': 'GL Mapper', 'is_opening': 'parent:is_opening', 'posting_date': 'parent:posting_date', 'parentfield': 'fields'}, 
		{'voucher_type': 'doctype', 'doctype': 'GL Mapper Detail', 'cost_center': '', 'voucher_no': 'name', 'against_voucher': None, 'table_field': '', 'transaction_date': 'voucher_date', 'debit': 'value:0', 'parent': 'Purchase Invoice', 'company': 'company', 'aging_date': 'aging_date', 'fiscal_year': 'fiscal_year', 'is_advance': None, 'remarks': 'remarks', 'account': 'tax_code', 'name': 'GLMDetail00004', 'idx': 3, 'against_voucher_type': None, 'against': 'credit_to', 'credit': 'ded_amount', 'parenttype': 'GL Mapper', 'is_opening': 'is_opening', 'posting_date': 'posting_date', 'parentfield': 'fields'}, 
		{'voucher_type': 'doctype', 'doctype': 'GL Mapper Detail', 'cost_center': '', 'voucher_no': 'name', 'against_voucher': 'name', 'table_field': '', 'transaction_date': 'voucher_date', 'debit': 'value:0', 'parent': 'Purchase Invoice', 'company': 'company', 'aging_date': 'aging_date', 'fiscal_year': 'fiscal_year', 'is_advance': None, 'remarks': 'remarks', 'account': 'credit_to', 'name': 'GLMDetail00005', 'idx': 4, 'against_voucher_type': "value:'Purchase Invoice'", 'against': 'against_expense_account', 'credit': 'total_amount_to_pay', 'parenttype': 'GL Mapper', 'is_opening': 'is_opening', 'posting_date': 'posting_date', 'parentfield': 'fields'},
		# GL Mapper - Purchase invoice with write off
		{'doc_type': 'Purchase Invoice with write off', 'doctype': 'GL Mapper', 'name': 'Purchase Invoice with write off', 'doctype': 'GL Mapper'},
		...
		{'doc_type': 'Sales Invoice', 'name': 'Sales Invoice', 'module': 'Accounts', 'doctype': 'GL Mapper'}, 
		{'voucher_type': 'parent:doctype', 'doctype': 'GL Mapper Detail', 'cost_center': 'cost_center', 'voucher_no': 'parent:name', 'against_voucher': None, 'table_field': 'entries', 'transaction_date': 'parent:voucher_date', 'debit': 'value:0', 'parent': 'Sales Invoice', 'company': 'parent:company', 'aging_date': 'parent:aging_date', 'fiscal_year': 'parent:fiscal_year', 'is_advance': None, 'remarks': 'parent:remarks', 'account': 'income_account', 'name': 'GLMDetail00006', 'idx': 1, 'against_voucher_type': None, 'against': 'parent:debit_to', 'credit': 'amount', 'parenttype': 'GL Mapper', 'is_opening': 'parent:is_opening', 'posting_date': 'parent:posting_date', 'parentfield': 'fields'}, 
		{'voucher_type': 'parent:doctype', 'doctype': 'GL Mapper Detail', 'cost_center': 'cost_center_other_charges', 'voucher_no': 'parent:name', 'against_voucher': None, 'table_field': 'other_charges', 'transaction_date': 'parent:voucher_date', 'debit': 'value:0', 'parent': 'Sales Invoice', 'company': 'parent:company', 'aging_date': 'parent:aging_date', 'fiscal_year': 'parent:fiscal_year', 'is_advance': None, 'remarks': 'parent:remarks', 'account': 'account_head', 'name': 'GLMDetail00007', 'idx': 2, 'against_voucher_type': None, 'against': 'parent:debit_to', 'credit': 'tax_amount', 'parenttype': 'GL Mapper', 'is_opening': 'parent:is_opening', 'posting_date': 'parent:posting_date', 'parentfield': 'fields'}, 
		{'voucher_type': 'doctype', 'doctype': 'GL Mapper Detail', 'cost_center': '', 'voucher_no': 'name', 'against_voucher': 'name', 'table_field': '', 'transaction_date': 'voucher_date', 'debit': 'grand_total', 'parent': 'Sales Invoice', 'company': 'company', 'aging_date': 'aging_date', 'fiscal_year': 'fiscal_year', 'is_advance': None, 'remarks': 'remarks', 'account': 'debit_to', 'name': 'GLMDetail00008', 'idx': 3, 'against_voucher_type': "value:'Sales Invoice'", 'against': 'against_income_account', 'credit': 'value:0', 'parenttype': 'GL Mapper', 'is_opening': 'is_opening', 'posting_date': 'posting_date', 'parentfield': 'fields'},
