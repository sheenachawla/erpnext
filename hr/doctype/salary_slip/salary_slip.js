...
cur_frm.cscript.fiscal_year = function(doc,dt,dn){
		$c_obj(wn.model.get_doclist(doc.doctype,doc.name), 'get_emp_and_leave_details','',function(r, rt) {
...
cur_frm.cscript.leave_without_pay = function(doc,dt,dn){
	if (doc.employee && doc.fiscal_year && doc.month) {
		$c_obj(wn.model.get_doclist(doc.doctype,doc.name), 'get_leave_details',doc.leave_without_pay,function(r, rt) {
			var doc = locals[dt][dn];
			cur_frm.refresh();
			calculate_all(doc, dt, dn);
		});
