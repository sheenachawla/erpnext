...
cur_frm.cscript.create_salary_slip = function(doc, cdt, cdn) {
	...
	$c('runserverobj', args={'method':'create_sal_slip','docs':wn.model.compress(wn.model.get_doclist (cdt, cdn))},callback);
}
...
cur_frm.cscript.submit_salary_slip = function(doc, cdt, cdn) {
	...
	if(check){
		...
		$c('runserverobj', args={'method':'submit_salary_slip','docs':wn.model.compress(wn.model.get_doclist (cdt, cdn))},callback);
	}
}
...
cur_frm.cscript.make_jv = function(doc, dt, dn) {
	...
	$c_obj(wn.model.get_doclist(dt,dn),'get_acc_details','',call_back);
}
