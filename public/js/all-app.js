...
this.$input.change(function(){var val=me.get();if(me.validate){val=me.validate(val);me.set_input(val);}
if(me.doc)
me.doc.fields[me.docfield.fieldname]=val;})},set_events:function(){var me=this;this.$w.find('.control-static').click(function(){me.toggle_editable(true);});},toggle_editable:function(editable){if(this.docfield.reqd)
